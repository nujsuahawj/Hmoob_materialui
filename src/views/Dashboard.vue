<template>
  <div class="team">
    ...
    <v-list-item>
      ...
      <v-list-item-content>
        <div class="overline text-right">Addoon ທັງໝົດ</div>
    ...
    <v-card-actions>
      ...
      <div class="overline">VISA Card ທັງໝົດ</div>
    </v-card-actions>
  </v-card>
      </v-flex>
       <v-flex
        ...
        <v-flex xs12 sm6 md4 lg3 v-for="person in team" :key="person.name">
              <v-card class="text-center ma-3">
                ...
                <v-card-text>
                  ...
                  <div class="grey--text">ຕຳແໜ່ງ {{person.role}}</div>
                </v-card-text>
                <v-card-actions>
...
export default {
  ...
  data : () => ({
    team: [
      {name: 'Jack Sainther', role: 'web developer', avatar:'/img1.png'},
