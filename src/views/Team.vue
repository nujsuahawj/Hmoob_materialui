<template>
  <div class="team">
    <h1 class="subheading grey--text">ທີມ</h1>
    <v-container >
      <v-layout row wrap>
         <v-flex
        sm6
    ...
    <v-list-item  >
      ...
      <v-list-item-content>
        <div class="overline text-right">Article ທັງໝົດ</div>
    ...
    <v-card-actions>
      ...
      <div class="overline">Iyad ທັງໝົດ</div>
    </v-card-actions>
  </v-card>
      </v-flex>
       <v-flex
    ...
    <v-list-item>
      ...
      <v-list-item-content>
        <div class="overline text-right">Abon ທັງໝົດ</div>
    ...
    <v-card-actions>
      ...
      <div class="overline">IdeaPro ທັງໝົດ</div>
    </v-card-actions>
  </v-card>
      </v-flex>
       <v-flex
    ...
    <v-list-item>
      ...
      <v-list-item-content>
        <div class="overline text-right">Shopping ທັງໝົດ</div>
    ...
    <v-list-item >
      ...
      <v-list-item-content>
        <div class="overline text-right">Folder ທັງໝົດ</div>
    ...
    <v-card-actions>
      ...
      <div class="overline">Prodect ທັງໝົດ</div>
    </v-card-actions>
  </v-card>
      </v-flex>
        <v-flex xs12 sm6 md4 lg3 v-for="person in team" :key="person.name">
              <v-card class="text-center ma-3">
                ...
                <v-card-text>
                  <div class="subheading">ທ່ານ {{person.name}}</div>
                  <div class="grey--text">ຕໍາແໜ່ງ {{person.role}}</div>
                </v-card-text>
                <v-card-actions>
...
export default {
  ...
  data : () => ({
    team: [
      {name: '໋Jack Sainther', role: 'web developer', avatar:'/img1.png'},
      {name: 'Nou Sainther', role: 'Graphic designer', avatar:'/img2.png'},
      {name: 'Nas Sainther', role: 'web developer', avatar:'/img3.png'},
      {name: 'Pov Sainther', role: 'Desktop developer', avatar:'/img4.png'},
    ]
  }),
}
</script>
